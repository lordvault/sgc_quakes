...
- **Max Event Age Filter**: Added `max_event_age_minutes` option (default: `60` minutes) to prevent false alerts and notifications when SGC seismologists publish retroactive manual reviews hours or days later.
